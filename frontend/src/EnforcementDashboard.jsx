...
function StatCard({ label, value, valueColor, sub }) {
  return (
    <div style={{
      ...
      {sub && (
        <div style={{ color: '#64748b', fontSize: 12, marginTop: 6, lineHeight: 1.4 }}>
          {sub}
        </div>
      )}
    </div>
        ...
        {Object.entries(sources).map(([src, pct]) => (
          <div key={src} style={{
            ...
            <div style={{
              ...
              background: colors[src] || '#475569', flexShrink: 0
            }}/>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
              ...
              <div style={{
                ...
                <span style={{ fontSize: 12, fontWeight: 400, color: '#475569', marginLeft: 4 }}>
                  AQI
                </span>
              </div>
            </div>
...
function SourceSummary({ priorities }) {
  ...
  const colors = {
    Industrial: '#ef4444', Traffic: '#f59e0b',
    Construction: '#0ea5e9', 'Dust/Natural': '#64748b'
  }
        ...
        <div key={src} style={{
          ...
          <div style={{ flex: 1 }}>
            <div style={{
              ...
              <span style={{
                fontFamily: 'Space Grotesk, sans-serif',
                color: colors[src], fontSize: 13, fontWeight: 600
              }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                width: `${(count / priorities.length) * 100}%`
              }}/>
            </div>
          </div>
        </div>
  ...
  return (
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{
          fontFamily: 'Space Grotesk, sans-serif',
          fontWeight: 700, fontSize: 15, color: '#f0f4f8'
        }}>
          VAYU
        </div>
        ...
        {data && (
          <div style={{ display: 'flex', gap: 12, marginBottom: 40, flexWrap: 'wrap' }}>
            ...
            <StatCard
              ...
              valueColor="#ef4444"
              sub="High or Severe severity threshold exceeded"
            />
            <StatCard
              label="Highest Priority"
              value={data.priorities[0]?.name
                .replace(', Chennai - CPCB', '')
                .replace(', Chennai - TNPCB', '')}
              valueColor="#f59e0b"
            ...
            <StatCard
              ...
              value={data.priorities[0]?.primary_source}
